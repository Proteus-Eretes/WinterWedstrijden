  ...
  <div>
    <v-navigation-drawer v-model="drawerOpen" clipped absolute>
      <v-list flat>
        ...
        <v-btn href="/Vlottijden_WW_2025.pdf" target="_blank" text width="100%" class="drawer--item">Vlottijden</v-btn>
      ...
      <v-toolbar-title z-index="-10">
        ...
        >
          ...
          >
            ...
            <div class="logoTitle">
              {{
                $router.currentRoute.name == "index"
                  ? "WinterWedstrijden"
      ...
      <v-toolbar-items class="hidden-sm-and-down menu-item">
        ...
        <v-menu offset-y>
          ...
          <v-list dense>
            ...
            <v-list-item>
              <v-btn href="/Vlottijden_WW_2025.pdf" target="_blank" text dark>Vlottijden</v-btn>
            </v-list-item>
          </v-list>
        </v-menu>
