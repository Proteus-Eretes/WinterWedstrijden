<template>
  <v-card flat light>
      ...
      <v-card-text>
        ...
        <a href="https://www.tudelftcampus.nl/nl/bereikbaarheid/" target="_blank">TuDelftcampus.nl</a>
        <br>
        <img src="/BetalenTU.jpg" class="baankaart" style="width: 70%; height: 70%;"  />
        <br>
        <img src="/BetalenTU2.jpg" class="baankaart" style="width: 60%; height: 60%;" />
      ...
      <v-card-text>
        ...
        2628 AT<br>
        Delft
        <img src="plattegrondpe-2026.png" class="baankaart" />
      </v-card-text>
      <v-card-title>
      ...
      <v-card-text>
        ...
        2628 AT<br>
        Delft
        <img src="/plattegrondlc.png" class="baankaart" />
      </v-card-text>
    </v-card>
  </template>
