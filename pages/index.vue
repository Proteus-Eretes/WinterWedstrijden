...
Wij vertrouwen op jullie begrip.
      ...
      <v-card light> 
        <v-card-title>Update 15-02-2025 - 09:00 </v-card-title>
            <v-card-text color="black">  
              Beste deelnemers, <br>
              Blok 2 zal door gaan. De temperatuur blijft laag, dus kleed gepast! <br>
              Het besluit voor blok 3 zal volgen om 13:00.
            </v-card-text>
      </v-card>
      <br>
      <v-card light> 
      ...
      <v-card light> 
        <v-card-title>Update 14-02-2025 - Kou maatregelen </v-card-title>
            <v-card-text color="black">  
              ...
              <br>
              Tips voor roeiers / stuurtjes / coaches / toeschouwers:
              <br><br>
              - Meerdere lagen <br>
              - Muts <br>
              - Water- en winddichte laag <br>
              - 2 paar sokken <br>
              - Zorg voor genoeg kleding tijdens op- en uitroeien <br>
              - Extra droge kleding sokken voor als je de boot uitkomt en  moet wachten <br>
            </v-card-text>
      </v-card>
      <br>
      <v-card light> 
      ...
      <v-card light> 
        <v-card-title>Weerupdate 12-02-2025 - CODE GEEL</v-card-title>
            <v-card-text color="black">
              ...
              <br>
              Zaterdag & Zondag, 2 uur voorafgaande aan elk blok.
          </v-card-text>
      </v-card>
      <br>
    <v-card light>
